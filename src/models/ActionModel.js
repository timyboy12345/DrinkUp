...
export class ActionModel extends QuestionInterface {
    ...
    selectQuestion(playerData) {
        if (this.getAction().includes('%player_name%')) {
...
const cards = [
    ...
    },
    {
        emoji: '👇',
        title: 'Down It',
        desc: `%player_name% must finish their drink!`,
        type: 'Default',
    },
    {
        emoji: '📸',
    ...
    },
    {
        emoji: '🎢',
        title: 'Slidin In',
        desc: `%player_name% must share their last 3 direct messages or finish their drink!`,
        type: 'Default',
    },
    {
        emoji: '👑',
    ...
    },
    {
        ...
        desc: `%player_name% gets to choose another player to drink`,
        type: 'Default',
    },
    {
        emoji: '🏋',
    ...
    },
    {
        ...
        title: 'Wild Card',
        desc:
            '%player_name% gets to challenge another player to a game / dare, loser drinks!',
        type: 'Default',
    },
    {
        emoji: '👶',
    ...
    },
    {
        ...
        desc: `%player_name% comes up with a rule for the rest of the game (ie. "Say cheers before every drink, if you don't, take another drink")`,
        type: 'Default',
    },
    {
        emoji: '👨‍⚖️',
    ...
    },
    {
        emoji: '🤖',
        title: `0010110101101`,
        desc: `%player_name% must "do the robot" dance or drink`,
        type: 'Default',
    },
    {
        emoji: '‼',
        title: `Double Whammy`,
        desc: `%player_name% takes two drinks together with another player`,
        type: 'Default',
    },
    {
        emoji: '🙆‍♂️',
