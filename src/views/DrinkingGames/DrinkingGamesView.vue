<template>
  <div class="mx-6 md:max-w-2xl lg:max-w-4xl md:mx-auto flex content-center flex-col pb-8">
    <div class="flex flex-col">
      ...
      <p class="opacity-70 mb-8 mt-2">Heb je een probleem het juiste drankspel te vinden? Hieronder vindt je alle
...
export default {
  ...
  async created() {
    ...
    const rawResponse = await fetch(`${directusBaseUrl}/items/drinking_games/?fields[]=*,images.directus_files_id.*,thumbnail.*`);
